...
docker-pkgs: gen amdexporter $(GPUAGENT_PRODUCER_DEP)
	${MAKE} EXPORTER_PREBUILT=1 libcopy-assets-RHEL9 rpmpkg rpmpkg-sriov rpmpkg-ual
	${MAKE} EXPORTER_PREBUILT=1 libcopy-assets-UBUNTU22 debpkg debpkg-sriov debpkg-ual
	${MAKE} EXPORTER_PREBUILT=1 UBUNTU_VERSION=noble libcopy-assets-UBUNTU24 debpkg debpkg-sriov debpkg-ual
